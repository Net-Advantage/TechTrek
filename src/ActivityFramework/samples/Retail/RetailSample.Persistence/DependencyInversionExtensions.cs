...
public static class DependencyInversionExtensions
{
    ...
    public static IServiceCollection AddRetailSamplePersistence(this IServiceCollection services, IConfigurationRoot configuration)
    {
        services.AddDbContextFactory<RetailSampleDbContext>((sp, options) =>
        {
            var applicationContext = sp.GetRequiredService<IApplicationContext>();
            var databaseName = $"RetailSampleDb_";
            ...
            var serverName = configuration.GetConnectionString("RetailSampleDbServerName");
